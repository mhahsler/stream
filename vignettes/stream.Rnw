...
fraud and intrusion detection. This requires that a detected outlier gets reported back to the user
...
In the first step, outlier detectors are trying to classify an input data point.
If a new data point does not belong to any
known cluster, the outlier detector must decide whether the data point represents a new outlier.
...
library("stream")
set.seed(1000)
stream <- DSD_Gaussians(k = 3, d = 2, o = 4, outlier_horizon = 10000,
                        separation = 0.3, lim = c(0,1))
@
...
library("stream")
set.seed(1000)
stream1 <- DSD_Gaussians(k = 3, d = 2, variance_lim = 0.2, lim = c(0, 5))
stream2 <- DSD_Gaussians(k = 3, d = 2, variance_lim = 2, lim = c(0, 5))
@
...
library("stream")
set.seed(1000)
stream1 <- DSD_Gaussians(k = 5, d = 2, variance_lim = 0.2, lim = c(0, 5),
                         separation_type = "Mahalanobis",
                         mahalanobis_separation = 4)
@
<<>>=
set.seed(1000)
stream2 <- DSD_Gaussians(k = 5, d = 2, variance_lim = 0.2, lim = c(0, 5),
                         separation_type = "Mahalanobis",
                         mahalanobis_separation = 10)
@
...
For working and assessment of outlier detectors, we want to generate some smaller portion
of outliers in the data stream. Outliers need to be marked and statistically just enough
...
library("stream")
set.seed(1000)
stream1 <- DSD_Gaussians(k = 5, d = 2, o = 5, variance_lim = 0.2, lim = c(0, 10),
                         separation_type = "Mahalanobis",
                         outlier_virtual_variance = 0.3)
@
<<>>=
set.seed(1000)
stream2 <- DSD_Gaussians(k = 5, d = 2, o = 5, variance_lim = 0.2, lim = c(0, 20),
                         separation_type = "Mahalanobis",
