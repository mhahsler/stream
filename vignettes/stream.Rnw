...
library("stream")
set.seed(1000)
stream1 <- DSD_Gaussians(k = 5, d = 2, variance_lim = 0.2, lim = c(0, 7),
                         separation_type = "Mahalanobis",
                         mahalanobis_separation = 4)
@
<<>>=
set.seed(1000)
stream2 <- DSD_Gaussians(k = 5, d = 2, variance_lim = 0.2, lim = c(0, 15),
                         separation_type = "Mahalanobis",
...
library("stream")
set.seed(1000)
stream1 <- DSD_Gaussians(k = 5, d = 2, o = 5, variance_lim = 0.2,
                         lim = c(0, 15), separation_type = "Mahalanobis",
                         outlier_virtual_variance = 0.3)
@
<<>>=
set.seed(1000)
stream2 <- DSD_Gaussians(k = 5, d = 2, o = 5, variance_lim = 0.2,
                         lim = c(0, 40), separation_type = "Mahalanobis",
